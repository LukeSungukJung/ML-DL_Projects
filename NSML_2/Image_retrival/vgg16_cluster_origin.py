...
IV_model = InceptionV3(include_top=False, weights="imagenet", input_shape=(224,224,3))
...
IV_output = covnet_transform(IV_model,X_train)
Kmeans_IV = create_train_kmeans(IV_output)
Kmeans_IV_pred = Kmeans_IV.predict(IV_output)
...
Kmeans_IV_pred_codes = [codes[x] for x in Kmeans_IV_pred]
...
print("KMeans Inception:", print_scores(X_lables, Kmeans_IV_pred_codes))
